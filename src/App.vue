...
<template>
	<div class="my-5 max-w-lg mx-auto bg-white shadow p-10">
		...
		<div class="my-5">
			...
			<select
				class="w-full p-2 bg-gray-100 boder border-gray-300 rounded-lg text-center text-xl font-bold text-gray-500 mt-5"
		...
		<div class="my-5 space-y-3 bg-gray-100 p-5">
			<h2 class="text-2xl font-extrabold text-gray-500 text-center">
